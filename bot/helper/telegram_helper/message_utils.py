...
from bot import AUTO_DELETE_MESSAGE_DURATION, LOGGER, status_reply_dict, status_reply_dict_lock, \
                ...
                AUTO_DELETE_UPLOAD_MESSAGE_DURATION, PICS, AUTO_DELETE_REPLY_MESSAGE_DURATION
...
def auto_delete_reply_message(bot, cmd_message: Message, bot_message: Message):
    if cmd_message.chat.type in ["private", "group"]:
        pass
    elif AUTO_DELETE_REPLY_MESSAGE_DURATION != -1:
        sleep(AUTO_DELETE_REPLY_MESSAGE_DURATION)
